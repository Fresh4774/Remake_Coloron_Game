class Game {
  ...
  * Display score
   ...
   */
  showGrade(score) {
    if (score > 30) return "GG";else
    if (score > 25) return "GG";else
    if (score > 20) return "GG";else
    if (score > 15) return "GG";else
    if (score > 13) return "GG";else
    if (score > 10) return "GG";else
    if (score > 5) return "GG";else
    return "GG";
  }
